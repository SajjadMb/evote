...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = ElectionUser
        fields = ('email', 'password', 'full_name', 'profile_photo', 'is_active', 'is_admin')
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'full_name', 'profile_photo', 'is_admin')
...
admin.site.register(ElectionUser, UserAdmin)
